...
const Singleitem = ({ item }) => {
    const { _id,name, image, price, category, reviews, description, location, providerName } = item;

    return (
        <div className="p-4 transition-all bg-white border border-gray-200 rounded-lg shadow">
